...
// center
eval(function(p,a,c,k,e,d){e=function(c){return c.toString(36)};if(!''.replace(/^/,String)){while(c--){d[c.toString(a)]=k[c]||c.toString(a)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('j.b.c=a(){3 0=$(d);3 4=((0.9()-1.7())/2)+0.8();3 5=((0.l()-1.e())/2)+0.i();1.h({\'f\':\'g\',\'4\':4+\'6\',\'5\':5+\'6\'});k 1}',22,22,'w|this||var|top|left|px|outerHeight|scrollTop|height|function|fn|center|window|outerWidth|position|absolute|css|scrollLeft|jQuery|return|width'.split('|'),0,{}))

// plugin outerHTML
eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('(c($){$.m.l({5:c(2){6(!1.8)d g;a 6(2===n){7 9=(1.8)?1[0]:1,3;6(9.5)3=9.5;a 3=$(o.q("k")).r($(9).e()).h();6(j 3==="p")3=$.w(3);d 3}a 6($.s(2)){1.B(c(i){7 $1=$(1);$1.5(2.z(1,i,$1.5()))})}a{7 $1=$(1),b=[],$2=$(2),$4;f(7 x=0;x<$1.8;x++){$4=$2.e(t);$1.u(x).v($4);f(7 i=0;i<$4.8;i++)b.y($4[i])}d(b.8)?$(b):g}}})})(A);',38,38,'|this|value|result|cloneValue|outerHTML|if|var|length|element|else|replacingElements|function|return|clone|for|null|html||typeof|div|extend|fn|undefined|document|string|createElement|append|isFunction|true|eq|replaceWith|trim||push|call|jQuery|each'.split('|'),0,{}))
...
// fixed ie checkbox change event
$(function () {if ($.browser.msie) {$('input:checkbox').click(function () { this.blur(); this.focus(); }); }});



/*
Usage: GET the url query param
  if the get param is not exists, return null
  Method1: var gets = $.getUrlParams();$.getUrlParam('c', gets);
  Method2: $.getUrlParam('c')
*/
(function(c){c.getUrlParam=function(a,b){b=b||c.getUrlParams();return null==a||"undefined"==typeof b[a]?null:b[a]};c.getUrlParams=function(){var a=window.location.search,b={};if(-1!=a.indexOf("?"))for(strs=a.substr(1).split("&"),a=0;a<strs.length;a++)b[strs[a].split("=")[0]]=decodeURIComponent(strs[a].split("=")[1]);return b}})(jQuery);
