(function () {
	...
	var FocusPic = {
		...
		CreateStyle : function(){
			...
			styleStr += ".gee_foucstit { position:absolute; overflow:hidden; bottom:0;_bottom:-1px; width:100%; left:0; padding:0px 0 0px; z-index:998; background: rgba(0, 0, 0, 0.33);}";
